...
const InnerPagesLayout: React.FC<InnerPagesLayoutProps> = ({title, children}) => {
  ...
  return (
    <div className="pt-16 md:pt-16 lg:pt-20 xl:pt-24">
      <div className="w-full bg-cover bg-[url(../assets/services2.jpg)] bg-fixed p-14 ">
        <div>
          <div className=" font-semibold text-[28px] lg:text-[36px] ">{title ? title : defaultPageTitle}</div>
